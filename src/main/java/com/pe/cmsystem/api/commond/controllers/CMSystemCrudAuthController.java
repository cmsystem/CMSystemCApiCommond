...
@Slf4j
public abstract class CMSystemCrudAuthController<E extends CMSystemEntityID, T extends CMSystemCrudService<E>> {
    protected final AdapterController adapterController = new AdapterController();
    private final T service;

    protected CMSystemCrudAuthController(T service) {
    ...
    public ResponseEntity<CMSystemResponseRest<E>> create(
        ...
        UsuarioEO usuario = ((UsuarioEO)entity);
    ...
    public String hashPassword(String password) {
        // Genera un salt automáticamente y hashea
